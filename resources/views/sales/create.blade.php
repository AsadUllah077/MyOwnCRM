...
@section('content')
    <div class="container">
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">{{ __('Create Sale') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sales.store') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="sale_number" readonly value="{{ old('sale_number',$pur_num) }}"
                                class="form-control @error('sale_number') is-invalid @enderror">
                            @error('sale_number')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
