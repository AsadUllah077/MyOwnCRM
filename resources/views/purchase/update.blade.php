                    ...
                    <form method="POST" action="{{ route('purchases.update', $purchase->id) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="purchase_number"
                                ...
                                readonly class="form-control @error('purchase_number') is-invalid @enderror">
                        ...
                        <div class="form-group mb-3">
                            <label>Notes</label>
                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $purchase->notes) }}</textarea>
                            @error('notes')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
